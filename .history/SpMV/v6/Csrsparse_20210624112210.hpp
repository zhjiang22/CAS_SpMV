...
__global__ void spmv_pcsr_kernel2(double * d_v,int * d_ptr,int N,double * d_out, int alpha, int beta)
{
                  ...
                  double* hy)
{
    ...
    spmv_pcsr_kernel2<T><<<ceil(hm/(float)64),64>>>(d_temp,hrowptr,hm,hy, halpha, hbeta);
}